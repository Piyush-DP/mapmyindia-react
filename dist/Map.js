    ...
    _defineProperty(_assertThisInitialized(_this), "renderMarkers", function () {
      ...
      markers.map(function (m) {
        if (m.position && Array.isArray(m.position)) {
          ...
          var icon = L.divIcon({
            html: "<img style='position:relative;width:35px;height:35px' src=" + m.icon + ">" + '<span style="position: absolute;left:1.7em;right: 1em;top:0.9em;bottom:3em; font-size:9px;font-weight:bold;width: 1px; color:white;" class="my-div-span">' + m.number + "</span>",
